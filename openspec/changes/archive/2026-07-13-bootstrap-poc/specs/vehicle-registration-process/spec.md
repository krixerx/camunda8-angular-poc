...
Business detail (fields, variables, forms) is specified in `docs/business/services/vehicle-registration/` — that markdown is the source of truth for process content. This spec covers the executable behavior.
